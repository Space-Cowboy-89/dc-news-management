...
public class UserCtrlConstants {
    ...
    public final static String SURNAME_SAMPLE_2 = "surname_sample_2";
    ...
    public final static String SURNAME_SAMPLE_3 = "surname_sample_3";
